...
export default function PizzaForm(props: SpecificDishFormProps) {
    ...
    return (
        <>
            ...
            <input id="no_of_slices" {...register("no_of_slices", {required: true, min: 1})} className={styles["pizza-input-color"]}/>
            ...
            <input {...register("diameter", {required: true, min: 20})} step="0.1" className={styles["pizza-input-color"]}/>
